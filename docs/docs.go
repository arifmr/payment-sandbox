...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/repository.DashboardStats"
                        }
                    },
                    "400": {
        ...
        "/admin/payments/{id}": {
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "payment intent id (uuid)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.PaymentActionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PaymentIntentResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/admin/refunds/{id}": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "action: APPROVE|REJECT|PROCESS|FAIL",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RefundActionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.TopupActionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/invoices": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "filter by status (PENDING/PAID/EXPIRED)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "RFC3339 timestamp lower bound on created_at",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "RFC3339 timestamp upper bound on created_at",
                        "name": "to",
                        "in": "query"
                    },
                    {
        ...
        "/pay/{token}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "payment token from invoice",
                        "name": "token",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PublicInvoiceResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RequestRefundRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.RefundActionRequest": {
            ...
            "properties": {
                "action": {
                    "description": "APPROVE | REJECT (when status REQUESTED), PROCESS | FAIL (when status APPROVED)",
                    "type": "string",
                    "enum": [
                        "APPROVE",
                        "REJECT",
